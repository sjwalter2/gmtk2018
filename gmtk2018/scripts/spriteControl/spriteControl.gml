...
if(fastDown && fastReleased && attackReady &&(currentSprite != spr_playerMidKick && currentSprite != spr_playerMidPunch && currentSprite != spr_playerWallGrab))
{
...
else if(slowDown && slowReleased && attackReady  && (currentSprite != spr_playerMidKick && currentSprite != spr_playerMidPunch && currentSprite != spr_playerWallGrab))
{
